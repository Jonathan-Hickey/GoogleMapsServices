...
{
    /// <summary>Indicates the status code resulting from the geocoding operation. This field may contain the following values.</summary>
    ...
    /// <summary>A unique identifier that can be used with other Google APIs. See the [Place ID overview](https://developers.google.com/maps/documentation/places/web-service/place-id).</summary>
    ...
    /// <summary>Indicates the address type of the geocoding result used for calculating directions.
    /// 
    ...
    public System.Collections.Generic.ICollection<Types2> Types { get; set; }
