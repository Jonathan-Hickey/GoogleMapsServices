...
public partial class GeocodingResult
{
    ...
    public ICollection<AddressComponent> Address_components { get; set; } = new System.Collections.ObjectModel.Collection<AddressComponent>();
    ...
    [System.ComponentModel.DataAnnotations.Required]
    public ICollection<string> Types { get; set; } = new System.Collections.ObjectModel.Collection<string>();
    ...
    public ICollection<string> Postcode_localities { get; set; }
